                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      child: Text(
                        ...
                        style: _getPriceText(index).isEmpty ? Theme.of(context).textTheme.subtitle.copyWith(fontSize: 14.0) : null),
                    )),
                  Gaps.hGap5,
                  Text("元"),
                ],
                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      child: Text(
                        ...
                        textAlign: TextAlign.end,
                        style: _list[index].price.isEmpty ? Theme.of(context).textTheme.subtitle.copyWith(fontSize: 14.0) : null),
                    )),
                  Gaps.hGap5,
